...
\begin{tikzpicture}[
  ...
  \draw[parptr, dashed] ($(j24.north west)+(0.1, 0)$) to[bend left=20] ($(d13.south)+(-0.15, 0)$);
  \draw[parptr, dashed] ($(b5.north)+(-0.05, 0)$) to[bend left=20] ($(j24.west)+(0, -0.05)$);
  ...
  \draw[parptr, dashed] ($(a8.north)+(0.05, 0)$) to[bend right=20] ($(j24.east)+(0, -0.05)$);
  ...
  \draw[c1ptr, dashed] ($(j24.west)+(0.05, -0.1)$) to[bend right=20] ($(b5.north)+(0.05, 0)$);

  % next (right) sibling pointers
  \draw[sibptr] ($(d13.east)+(0, 0.025)$) to[bend left=10] (d22.west);
  \draw[sibptr, dashed] (b2.east) to[bend left=10] (j24.west);
  \draw[sibptr] (b5.east) to[bend left=10] (a8.west);
  \draw[sibptr, dashed] (j24.east) to[bend left=10] (a12.west);
